...
import org.jbehave.tutorials.etsy.steps.pages.AdvancedSearch;
import org.jbehave.tutorials.etsy.steps.pages.Buy;
import org.jbehave.tutorials.etsy.steps.pages.CartContents;
import org.jbehave.tutorials.etsy.steps.pages.Home;
import org.jbehave.tutorials.etsy.steps.pages.SearchResults;
import org.jbehave.tutorials.etsy.steps.pages.Site;
import org.jbehave.tutorials.etsy.steps.pages.Treasury;
...
public class EtsyDotComSteps {
    ...
    public void thereAreSearchResults() {
        assertThat(searchResults.getElems().isEmpty(), Matchers.is(false));
    }
}
